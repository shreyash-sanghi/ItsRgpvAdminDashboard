...
import sidebarPath from "../routes/Sidebar"
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {sidebarPath.map((info) => (
                <>
                  {info.submenu ? (<>
                    <SidebarLinkGroup activecondition={pathname.includes(info.name)}>
                      {(handleClick, open) => {
                        return (
                          <React.Fragment>
                            <a
                            ...
                            <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                              <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                                {info.submenu.map((subInfo, index) => {
                                  return (<>
                                    <li className="mb-1 last:mb-0" key={index} >
                                      <NavLink end
                                        to={subInfo.path}
                                        className={({ isActive }) =>
                                          " transition flex items-center gap-2 duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                                        }
                                      >
                                        {subInfo.icon}
